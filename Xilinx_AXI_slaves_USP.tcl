...
#	connect_bd_net [get_bd_pins -regex ${primary_serdes}/gt_qpllclk_quad[:digit:]_out]      [get_bd_pins ${C2C_PHY}/gt_qpllclk_quad[:digit:]_in]
#	connect_bd_net [get_bd_pins ${primary_serdes}/gt_qpllrefclk_quad[:digit:]_out]   [get_bd_pins ${C2C_PHY}/gt_qpllrefclk_quad[:digit:]_in]
