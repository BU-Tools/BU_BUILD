...
proc BUILD_AXI_DATA_WIDTH {name src_width dst_width clk rstn axi_masters axi_master_clks axi_master_rstns} {
    ...
    [AXI_CTL_DEV_CONNECT $name $axi_interconnect $axi_clk $axi_rstn $axi_freq $addr_offset $addr_range -1]
