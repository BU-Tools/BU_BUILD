...
[BUILD_AXI_INTERCONNECT ZYNQ_AXI_INTERCONNECT ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} [list processing_system7_0/M_AXI_GP0] [list ${AXI_MASTER_CLK}] [list ${AXI_MASTER_RSTN}]]
